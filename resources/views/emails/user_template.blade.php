...
<span class="preheader">{!! trans('medianet-dev.backpack-form::formbuilder.emails.message_user', ['app_name' => config('app.name')]) !!}</span>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        @else
                            {!! trans('medianet-dev.backpack-form::formbuilder.emails.message_user', ['app_name' => config('app.name')]) !!}
                        @endif
