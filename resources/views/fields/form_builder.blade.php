...
@push('after_scripts')
    ...
    <script type="module" src="{{ asset('vendor/medianet-dev/backpack-form/js/form-builder.min.js') }}"></script>
    {{-- <script src="{{ asset('vendor/medianet/backpack-form/js/form-render.min.js') }}"></script> --}}
    <script>
        jQuery(function ($) {
            ...
            function saveForm(formData) {
                ...
                new Noty({
                    type: "success",
                    text: '{{ __("medianet.backpack-form::formbuilder.labels.form_saved") }}',
                }).show();
            }
        });
    </script>
